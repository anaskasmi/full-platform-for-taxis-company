...
export default {
  ...
  data() {
    return {
      items: [
        { title: "Profile", icon: "person",link:{ name: 'DriverDashboard_profile'} },
        { title: "Change Passowrd", icon: "vpn_key" ,link:{ name: 'DriverDashboard_changePassword'}}
      ],
      right: null,
      role: "Driver",
      name: "",
  ...
  computed: {
    show() {
      return this.$store.state.showDrawerDriver;
    }
  },
  methods: {
    BASE_URL()
