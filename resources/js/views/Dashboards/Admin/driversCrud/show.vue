        ...
        <div class="pa-0 ma-0 " v-if="$mq=='desktop'">
            ...
            <div>
                ...
                <v-btn
                    ...
                    :to="{name : 'AdminDashboard_drivers_edit',params:{id:id}}"
                >
        ...
        <div class="pa-0 ma-0 " v-if="$mq=='mobile'">
            ...
            <div class="container px-4">
                ...
                <div>
                    ...
                    <v-btn color="grey" block text tile class="" :to="driversRoute">
                        <v-icon class="mr-2">keyboard_return</v-icon>drivers
                    </v-btn>
                    <hr>
                    <v-btn
                    ...
                    <div class="table-responsive">
                        <div class="">
                            <div class="w-50 mx-auto" v-if="profileImage !== false">
                                <a :href="profileImage">
                                    <img :src="profileImage" alt class="img-fluid img-thumbnail rounded" />
                                </a>
                            </div>
                        ...
                        <table class="table table-bordered table-hover table-striped">
                            ...
                            <tr>
                                <td class="text-uppercase align-middle fitCell">created at</td>
                                <td class=" align-middle fitCell">{{driver.created_at}}</td>
                            </tr>
                            </tbody>
                        </table>
                    </div>
        ...
        .then(result => {
          if (result.value) {
            axios.defaults.headers.common["Authorization"] =
              "Bearer " + this.$store.state.token_admin;
            axios
              .delete(this.BASE_URL() + "/api/admin/driver/" + id)
              .then(data => {
                this.$router.push({ name: "AdminDashboard_drivers" });
                this.$swal.fire(
                  "Deleted!",
              ...
              .catch(err => {
                this.$swal.fire({
                  title: "error",
                  text: "we couldnt delete this driver",
                  type: "warning"
                });
              });
          }
