            ...
            <div>
                ...
                <form id="form" @submit.prevent="editDriver">
                    <div class="form-group">
                        ...
                        <v-text-field :rules="rules" name="FirstName" v-model="driver.FirstName"
                    ...
                    <div class="form-group">
                        <v-text-field :rules="rules" v-model="driver.HomePhone" name="HomePhone"
                                      label="Home Phone"></v-text-field>
                    </div>

                    <div class="form-group">
                        <v-text-field :rules="rules" v-model="driver.TAXI_HOST" name="TAXI_HOST"
                                      label="TAXI HOST"></v-text-field>
                    </div>
        ...
        <div class="pa-0 ma-0 " v-if="$mq=='mobile'">
            ...
            <div class="container px-4">
                ...
                <div>
                    ...
                    <!-- back button -->
                    <div class="">
                        <v-btn color="grey" text tile class="my-4" block :to="driversRoute">
                            <v-icon class="mr-2">keyboard_return</v-icon>
                            drivers
                        </v-btn>
                    </div>
                    ...
                    <form id="form" @submit.prevent="editDriver">
                        ...
                        <hr/>
                        <!-- assigne new password -->
                        <v-btn class="pl-0" block color="info" text @click="show_password_assigne = !show_password_assigne">
                            <!-- icon -->
                            <v-icon>arrow_drop_down</v-icon>
                            <!-- text -->
                            Assigne Password
                        ...
                        >
                            ...
                            <div class="text-white text-uppercase">
                                If no new password assigned, The old password will stay the same
                            </div>
                        ...
                        @endif-->
                        <!-- submit btn -->
                            <v-btn color="success" tile class="" block type="submit">submit</v-btn>
                            <v-btn
                                color="grey lighten-1"
                                dark
                                tile
