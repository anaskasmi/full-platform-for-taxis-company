            ...
            <div>
                ...
                <div v-if="!loading" class="text-center">
                    ...
                    <v-col class="text-center pa-0 ma-0" cols="12">
                        <v-btn rounded small class="title text-uppercase text-center mb-6 mt-2" color="info">Admin
                        </v-btn>
                    </v-col>
            ...
            <div class="container px-4 mt-6">
                ...
                <div>
                    ...
                    <div v-if="!loading" class="text-center">
                        ...
                        <v-btn class=" text-uppercase text-center " block color="primary" tile outlined>{{email}}
                        </v-btn>
                    </div>
                </div>
            </div>
