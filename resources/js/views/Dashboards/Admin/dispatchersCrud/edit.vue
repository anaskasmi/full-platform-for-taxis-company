<template>
    <div>
       ...
       <div class="row col-12">
        ...
        <!-- form -->
    <form id="form" @submit.prevent="editDispatcher">    
    ...
    >
     ...
     <div class="form-group">
        <v-text-field :rules="rules" name="name" v-model="dispatcher.name" label="Name"></v-text-field>
     </div>

    
     <div class="form-group">
        <v-text-field :rules="rules" name="email"  v-model="dispatcher.email" label="email"></v-text-field>
     </div>
...
<div class="form-group">
        ...
        >
              <v-app-bar dark color="blue lighten-3" dense flat>
                          <v-toolbar-title dense>Dispatcher image</v-toolbar-title>
              </v-app-bar>
        ...
        <div class="row col-12">
              <v-card-text > 
                  ...
                  <v-file-input
                      ...
                      placeholder="New Dispatcher image"
    ...
    methods: {
        BASE_URL()
      {
        ...
        editDispatcher(){
            ...
            console.log(formData);
            axios.defaults.headers.common['Authorization'] = 'Bearer '+ this.$store.state.token_admin;
axios.post(this.BASE_URL()+'/api/admin/dispatcher/'+this.dispatcher.id,formData)
            .then(response => { 
                
                this.$router.push({name:'AdminDashboard_dispatchers_show',params:{id:response.data.data[0].id}})
