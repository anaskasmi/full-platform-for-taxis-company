<template>
  <div>
      ...
      <v-tooltip top v-if="!noShiftsFound">
        <template v-slot:activator="{ on }">
          <a
            ...
            :href="BASE_URL() +
          '/api/admin/reports/DailyLogSheet/' +
          idEncrypted +
          '/printPDF/'+date"
            target="_blank"
          >
      ...
      <table class="table table-bordered table-hover">
        ...
        <tbody>
          ...
          <tr class="table table-borderless">
            ...
            <td class="table-primary font-weight-bold" style="font-size: 0.8em;  font-weight: bold; max-width:100%; white-space:nowrap;">${{total_fare}}</td>
            <td class="table-primary font-weight-bold" style="font-size: 0.8em;  font-weight: bold; max-width:100%; white-space:nowrap;">${{total_tip}}</td>
            <td class="table-primary font-weight-bold" style="font-size: 0.8em;  font-weight: bold; max-width:100%; white-space:nowrap;">${{total_total}}</td>
    ...
    <v-alert
      ...
      class="mb-12"
      align="center"
    >Sorry, No shifts Found For this day! chose another day</v-alert>
  </div>
</template>
<script>
...
export default {
  ...
  methods: {
    ...
    getReport(date) {
      ...
      axios
        .post(
          this.BASE_URL() + "/api/admin/reports/DailyLogSheet/day/" + this.id,
          {
            date: this.date
          }
        )
