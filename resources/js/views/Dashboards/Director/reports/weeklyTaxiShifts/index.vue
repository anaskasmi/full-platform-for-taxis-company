...
import director_comments from '@/js/views/Dashboards/Director/reports/weeklyTaxiShifts/director_comments.vue';
import specialShifts from '@/js/views/Dashboards/Director/reports/weeklyTaxiShifts/specialShifts.vue';
import shifts from '@/js/views/Dashboards/Director/reports/weeklyTaxiShifts/shifts.vue';
...
export default {
    ...
    computed:{
        backRoute(){
            return {name : 'DirectorDashboard_reports'};
        },
...
axios.get(this.BASE_URL()+'/api/director/reports/WeeklyTaxiShifts/list?date='+this.date)
            .then(res=>{
