    ...
    <div class="ma-0 pa-0">
        <div class="pa-0 ma-0 " v-if="$mq=='desktop'">
            ...
            <div>
                ...
                <v-btn color="success" outlined class="float-right mx-4"
                       :to="{name : 'DispatcherDashboard_drivers_edit',params:{id:id}}">
                    <v-icon class="mr-2">edit</v-icon>
                    edit
                </v-btn>
                <v-btn color="red " outlined class="float-right" @click="deleteDriver(driver.PermitNumber,driver.Name)">
                    ...
                    <div class="row col-12">
                        ...
                        <div class="col-2" v-if="profileImage === false">
                            <a :href="BASE_URL()+'/storage/uploads/IMAGES/man.png'">
                                <img :src="BASE_URL()+'/storage/uploads/IMAGES/man.png'" alt=""
        ...
        <div class="pa-0 ma-0 " v-if="$mq=='mobile'">
            ...
            <div class="container px-4">
                ...
                <div>
                    ...
                    <v-btn color="grey" text tile block  class="my-4" :to="driversRoute"> <v-icon class="">keyboard_return</v-icon>drivers </v-btn>
                    <hr>
                    <v-btn color="success" outlined block class="my-4" :to="{name : 'DispatcherDashboard_drivers_edit',params:{id:id}}" > <v-icon class="mr-2">edit</v-icon> edit </v-btn>
                    <v-btn color="red " outlined block class="mb-2" @click="deleteDriver(driver.PermitNumber,driver.Name)">  <v-icon class="mr-2">delete</v-icon> delete </v-btn>

                    <div class="table-responsive mt-6">
                        <div class="row justify-center">

                            <div class="w-50 " v-if="profileImage !== false">
                                <a :href="profileImage">
                                    <img :src="profileImage" alt=""  class="img-fluid img-thumbnail rounded ">
                                </a>
                            </div>
                        ...
                        <table class="table table-bordered table-hover table-striped">
                            ...
                            <tr>
                                <td class="align-middle fitCell">Name</td>
                                <td class="align-middle fitCell">{{driver.Name}}</td>
                            </tr>
                            <tr>

                                <td class="align-middle fitCell">First Name</td>
                                <td class="align-middle fitCell"> {{driver.FirstName}}</td>
                            </tr>
                            <tr>

                                <td class="align-middle fitCell">Last Name</td>
                                <td class="align-middle fitCell"> {{driver.LastName}}</td>
                            </tr>


                            <tr>
                                <td class="align-middle fitCell">permit Number</td>
                                <td class="align-middle fitCell">{{driver.PermitNumber}}</td>
                            </tr>
                            <tr>

                                <td class="align-middle fitCell">License Number</td>
                                <td class="align-middle fitCell">{{driver.LicenseNumber}}</td>
                            </tr>
                            <tr>

                                <td class="align-middle fitCell">License Expiry</td>
                                <td class="align-middle fitCell">{{driver.LicenseExpiry}}</td>
                            </tr>
                            <tr>

                                <td class="align-middle fitCell">Permit Expiry</td>
                                <td class="align-middle fitCell">{{driver.PermitExpiry}}</td>
                            </tr>
                            <tr>

                                <td class="align-middle fitCell">Abstract Expiry</td>
                                <td class="align-middle fitCell">{{driver.AbstractExpiry}}</td>
                            </tr>
                            <tr>

                                <td class="align-middle fitCell">Home Phone</td>
                                <td class="align-middle fitCell">{{driver.HomePhone}}</td>
                            </tr>
                            <tr>

                                <td class="align-middle fitCell">TAXI HOST</td>
                                <td class="align-middle fitCell">{{driver.TAXI_HOST}}</td>
                            </tr>
                            <tr>

                                <td class="align-middle fitCell">ADDRESS</td>
                                <td class="align-middle fitCell">{{driver.ADDRESS}}</td>
                            </tr>
                            <tr>

                                <td class="align-middle fitCell">EMAIL</td>
                                <td class="align-middle fitCell">{{driver.email}}</td>
                            </tr>
                            <tr>

                                <td class="align-middle fitCell">START DATE</td>
                                <td class="align-middle fitCell">{{driver.START_DATE}}</td>
                            </tr>
                            <tr>

                                <td class="align-middle fitCell">END DATE</td>
                                <td class="align-middle fitCell">{{driver.END_DATE}}</td>
                            </tr>
                            <tr>

                                <td class="align-middle fitCell">DRIVER STATUS</td>
                                <td class="align-middle fitCell">{{driver.DRIVER_STATUS}}</td>
                            </tr>
                            <tr>

                                <td class="align-middle fitCell">LICENSE CLASS</td>
                                <td class="align-middle fitCell">{{driver.LICENSE_CLASS}}</td>
                            </tr>
                            <!-- start of papers -->
                            <tr>
                                <td class="text-uppercase align-middle fitCell">LICENSE FILE</td>
                                <td>
                                    <a v-if="driver.LICENSE_PATH" :href="LICENSE_PATH" target="_blank">
                                        <img  class="img-thumbnail rounded" :src="LICENSE_PATH">
                                    </a>
                                    <div v-if="LICENSE_PATH===false" class="text-muted"> - </div>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td class="text-uppercase align-middle fitCell">PERMIT FILE</td>
                                <td>
                                    <a v-if="driver.PERMIT_PATH" :href="PERMIT_PATH" target="_blank">
                                        <img  class="img-thumbnail rounded" :src="PERMIT_PATH">
                                    </a>
                                    <div v-if="PERMIT_PATH===false" class="text-muted"> - </div>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td class="text-uppercase align-middle fitCell">TAXIHOST FILE</td>
                                <td>
                                    <a v-if="driver.TAXIHOST_PATH" :href="TAXIHOST_PATH" target="_blank">
                                        <img class="img-thumbnail rounded" :src="TAXIHOST_PATH">
                                    </a>
                                    <div v-if="TAXIHOST_PATH===false" class="text-muted"> - </div>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td class="text-uppercase align-middle fitCell">ABSTRACT FILE</td>
                                <td >
                                    <a v-if="driver.ABSTRACT_PATH" :href="ABSTRACT_PATH" target="_blank">
                                        <img  class="img-thumbnail rounded" :src="ABSTRACT_PATH">
                                    </a>
                                    <div  v-if="ABSTRACT_PATH===false" class="text-muted"> - </div>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td class="text-uppercase align-middle fitCell">SP FILE</td>
                                <td >

                                    <a v-if="driver.SP_FILE_PATH" :href="SP_FILE_PATH" target="_blank">
                                        <img class="img-thumbnail rounded" :src="SP_FILE_PATH">
                                    </a>
                                    <div v-if="SP_FILE_PATH===false" class="text-muted"> - </div>
                                </td>
                            </tr>
