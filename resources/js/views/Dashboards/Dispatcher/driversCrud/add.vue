            ...
            <div class="container px-4">
                <div>
                    ...
                    <div class="row justify-center">
                        <v-btn  color="grey" text tile class="text-center" :to="driversRoute">
                            <v-icon class="mr-2">keyboard_return</v-icon>drivers
                        </v-btn>
                    </div>
                    <hr />
                    ...
                    <form id="form" @submit.prevent="storeDriver">
                        ...
                        <hr />
                        <!-- assigne new password -->
                        <v-btn class="text-center" color="info" block text @click="show_password_assigne = !show_password_assigne">
                            <!-- icon -->
                            <v-icon>arrow_drop_down</v-icon>
                            <!-- text -->
                            Assigne Password
...
export default {
  ...
  methods: {
    ...
    storeDriver() {
      ...
      axios
        .post(this.BASE_URL()+"/api/dispatcher/driver", formData)
        .then(response => {
          this.$router.push({
