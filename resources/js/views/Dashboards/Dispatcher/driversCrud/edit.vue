            ...
            <div class="container px-4">
                ...
                <div>
                    ...
                    <div class="text-center">
                        <v-btn color="grey" text tile block :to="driversRoute">
                            <v-icon class="mr-2">keyboard_return</v-icon>drivers
                        </v-btn>
                    </div>
                    <hr />
                    ...
                    <form id="form" @submit.prevent="editDriver">
                                ...
                                <div >
                                    <v-card-text>
                                        <v-row class="row justify-center" >
                                            <!-- new image -->
                                            <div v-if="profileImage_newUrl" id="preview" class="">
                                                <img v-if="profileImage_newUrl" :src="profileImage_newUrl" />
                                            </div>
                                            <!-- old image -->
                                            <div v-if="!profileImage_newUrl" id="preview" class="">
                                            ...
                                            <v-row class="row justify-center my-4">
                                                <div class="">
                                                    <label for="image">
                                                        <input
                                                            type="file"
                                                            ...
                                                            name="image"
                                                        />
                                                        <div class="upload_btn upload_info border border-info " >
                                                            <v-icon color="blue darken-2 mr-4">mdi-upload-outline</v-icon>Upload New Image
                                                        </div>
                                                    </label>
                                                </div>
                            ...
                            <v-card flat outlined max-width="100%" class="mx-auto">
                                ...
                                <div>
                                    <v-card-text>
                                        <v-row  class="row justify-center" >
                                            <!-- new image -->
                                            <div v-if="LICENSE_PATH_newUrl" id="preview" >
                                                <img v-if="LICENSE_PATH_newUrl" :src="LICENSE_PATH_newUrl" />
                                            </div>
                                            <!-- old image -->
                                            <div v-if="!LICENSE_PATH_newUrl" id="preview" >
                        ...
                        <div class="form-group">
                            <v-card flat outlined max-width="100%" class="mx-auto">
                                ...
                                <v-row  class="row justify-center">
                                    <!-- new image -->
                                    <div v-if="SP_FILE_PATH_newUrl" id="preview">
                                        <img v-if="SP_FILE_PATH_newUrl" :src="SP_FILE_PATH_newUrl" />
                                    </div>
                                    <!-- old image -->
                                    <div v-if="!SP_FILE_PATH_newUrl" id="preview">
                        ...
                        <div class="form-group">
                            <v-card flat outlined max-width="100%" class="mx-auto">
                                ...
                                <div  >
                                    <v-row  class="row justify-center" >
                                        <!-- new image -->
                                        <div v-if="PERMIT_PATH_newUrl" id="preview" >
                                            <img v-if="PERMIT_PATH_newUrl" :src="PERMIT_PATH_newUrl" />
                                        </div>
                                        <!-- old image -->
                                        <div v-if="!PERMIT_PATH_newUrl" id="preview" >
                            ...
                            <v-card flat outlined max-width="100%" class="mx-auto">
                                ...
                                <div >
                                    <v-card-text>
                                        ...
                                        <v-row  class="row justify-center">
                                            <!-- new image -->
                                            <div v-if="TAXIHOST_PATH_newUrl" id="preview" >
                                                <img v-if="TAXIHOST_PATH_newUrl" :src="TAXIHOST_PATH_newUrl" />
                                            </div>
                                            <!-- old image -->
                                            <div v-if="!TAXIHOST_PATH_newUrl" id="preview" >
                            ...
                            <v-card flat outlined max-width="100%" class="mx-auto">
                                ...
                                <div >
                                    <v-card-text>
                                        ...
                                        <v-row  class="row justify-center">
                                            <!-- new image -->
                                            <div v-if="ABSTRACT_PATH_newUrl" id="preview" >
                                                <img v-if="ABSTRACT_PATH_newUrl" :src="ABSTRACT_PATH_newUrl" />
                                            </div>
                                            <!-- old image -->
                                            <div v-if="!ABSTRACT_PATH_newUrl" id="preview" >
                        ...
                        <hr />
                        <!-- assigne new password -->
                        <v-btn block color="info" text @click="show_password_assigne = !show_password_assigne">
                            <!-- icon -->
                            <v-icon>arrow_drop_down</v-icon>
                            <!-- text -->
                            Assigne Password
                        ...
                        <v-alert
                            ...
                            align="center"
                        >
                            <div class=" text-center text-white">PS :If no password assigned, The old password will remain the same
                            </div>
                        ...
                        @endif-->
                        <!-- submit btn -->
                            <v-btn color="success"  block tile  type="submit">submit</v-btn>
                            <v-btn
                                color="grey lighten-1"
                                dark
                                tile
