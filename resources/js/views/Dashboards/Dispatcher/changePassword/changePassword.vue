            ...
            <div>
                ...
                <v-form ref="form" v-model="valid" lazy-validation class="mt-12">
                    ...
                    <div class="row col-12 d-flex justify-content-center mt-10">
                        ...
                        <v-btn color="grey" tile outlined @click="$router.push({ name: 'DispatcherDashboard_profile' })"
                               class="col-2 ml-3">Cancel
                        </v-btn>
                    </div>
                </v-form>
            </div>
                ...
                <div>
                    ...
                    <v-form ref="form" v-model="valid" lazy-validation class="mt-12">
                        ...
                        <div class="">
                            ...
                            <v-btn color="grey" tile outlined block
                                   @click="$router.push({ name: 'DispatcherDashboard_profile' })" class="my-4">
                                Cancel
                            </v-btn>
                    </v-form>
                </div>
        ...
        methods: {
            ...
            validate() {
                if (this.$refs.form.validate()) {
                    ...
                    axios
                        .post(
                            this.BASE_URL() + "/api/dispatcher/auth/changePassword",
                            this.formData
                        )
                        .then(res => {
