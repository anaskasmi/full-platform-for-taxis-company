        ...
        <v-card-text>
          <v-container>
            ...
            <v-container>
              ...
              <v-row>
                <v-btn color="info" class="mt-2" tile block @click="editVehicle()">UPDATE</v-btn>
              </v-row>
            </v-container>
          </v-container>
        </v-card-text>
                ...
                <table class="table table-striped table-hover">
                  <tbody>
                    <tr v-for="(rotationsCategory, index) in rotationsCategories" :key="index">
                      ...
                      >{{openedVehicleMarks[rotationsCategory.id]}}</th>
            ...
            <td>
              <v-tooltip bottom>
                <template v-slot:activator="{ on }">
                  <v-btn outlined color="teal darken-3" v-on="on" @click="openMarksDialog(vehicle)">
