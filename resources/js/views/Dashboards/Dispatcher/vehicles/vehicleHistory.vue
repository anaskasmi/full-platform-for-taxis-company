<template>
            ...
            <div class="container px-4">
                <div class="wrapper_box">
                    ...
                    <v-dialog v-model="addDialogIsOpen" max-width="800px" persistent>
                        <v-card v-if="addDialogIsOpen">
                            <v-container>
                                <v-btn text color="black" block class="my-4" @click="closeAddDialog()">
                                    <v-icon>close</v-icon>
                                </v-btn>
    ...
    color: #2196f3;"
                    ...
                    <v-dialog v-model="editDialogIsOpen" max-width="800px" persistent>
                        <v-card v-if="editDialogIsOpen">
                            <v-container>
                                <v-btn text color="black" block class="my-4" @click="closeEditDialog()">
                                    <v-icon>close</v-icon>
                                </v-btn>
                                <div
    ...
    export default {
        ...
        methods: {
            ...
            fetchRotations() {
                let url =
                    this.BASE_URL() +
                    "/api/dispatcher/rotationsByVehicle/" +
