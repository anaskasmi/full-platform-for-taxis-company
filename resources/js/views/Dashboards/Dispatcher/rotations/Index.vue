      ...
      <div class="wrapper_box">
        ...
        <v-dialog v-model="addDialogIsOpen" max-width="800px" persistent>
          <v-card v-if="addDialogIsOpen">
            <v-container>
              <v-row
                class="col-12 justify-content-around align-content-center mx-0 px-0 pt-10"
              >
                <div
                  class="text-uppercase font-weight-black mx-8"
                  style="font-size: 2em; color: #2196f3"
                >
                  New Rotation
                </div>
                <v-spacer></v-spacer>
                      ...
                      >
                        ...
                        >
                          ...
                          <v-btn
                            text
                            color="primary"
                            @click="$refs.menu.save(addForm.date)"
                          >
                            OK
                          </v-btn>
                        </v-date-picker>
                      ...
                      >
                        ...
                        >
                          ...
                          <v-btn
                            text
                            color="primary"
                            @click="$refs.menu.save(editForm.date)"
                          >
                            OK
                          </v-btn>
                        </v-date-picker>
        ...
        <div>
                        ...
                        <div class="input-group mb-4">
                          ...
                          <div class="input-group-prepend">
                            <button
                              ...
                              class="btn btn-dark"
                              @click.prevent="
                                search(searchByDate, 'searchByDate')
                              "
                            >
                          ...
                          <div class="input-group mb-4">
                            ...
                            <div class="input-group-prepend">
                              <button
                                ...
                                class="btn btn-dark"
                                @click.prevent="
                                  search(searchByJobId, 'searchByJobId')
                                "
                              >
                                <v-icon dark small>search</v-icon>
                              </button>
                        ...
                        <form>
                          <div class="input-group mb-4">
                            ...
                            <input
                              ...
                              class="form-control"
                              @input="
                                search(searchByBadgeId, 'searchByBadgeId')
                              "
                            />
          ...
          <div class="card border-info mb-6" style="border-radius: 0">
            <div
              class="card-header text-white border-primary text-center text-uppercase"
            ...
            <div class="card-body border-dark">
              <v-select-search
                @input="
                  search(
                    currentRotationCategory ? currentRotationCategory.id : null,
                    'searchByCategoryId'
                  )
                "
          ...
          >
            ...
            >
              ...
              <span v-if="currentRotationCategory">{{
                currentRotationCategory.name
              }}</span>
              <span v-else> Rotations</span>
              <span v-if="searchByDate">, For Date : {{ searchByDate }}</span>
              <span v-if="searchByBadgeId"
                >, For Driver ID : {{ searchByBadgeId }}</span
              >
              <span v-if="searchByVehicleNumber"
                >, For Vehicle : {{ searchByVehicleNumber }}</span
              >
              <span v-if="searchByJobId"
                >, For Job ID : {{ searchByJobId }}</span
              >
            </div>
          </div>
          <!--end count rotations-->
                ...
                <tr v-for="(rotation, i) in sortedRows" :key="i">
                  ...
                  >
                    ...
                    <v-tooltip bottom v-else>
                      ...
                      <span
                        >This Driver doesnt exist try another badge ID!</span
                      >
                    </v-tooltip>
                  </td>
                  <td
                  ...
                  <td class="align-middle" style="color: #3c6382">
                    {{ rotation.job_id }}
                  </td>
                  <td class="align-middle" style="color: #3c6382">
                    {{ rotation.rotationsCategory }}
                  </td>
                  <td class="align-middle" style="color: #3c6382">
                    {{ rotation.city }}
                  </td>
                  ...
                  <td
                    colspan="2"
                    class="font-italic align-middle"
                    style="color: grey"
                  >
                    {{ rotation.note }}
                  </td>
                  <td class="align-middle" style="color: grey">
                    {{ rotation.owner }}
                  </td>
        ...
        <div class="">
          ...
          <v-dialog v-model="addDialogIsOpen" max-width="800px" persistent>
            <v-card v-if="addDialogIsOpen">
              <v-container>
                ...
                <v-row
                  class="col-12 justify-content-around align-content-center mx-0 px-0"
                >
                  <div
                    class="text-uppercase font-weight-black mx-8"
                    style="font-size: 1.4em; color: #2196f3"
                  >
                    New Rotation
                  </div>
                </v-row>
          ...
          <transition mode="out-in">
            <div class="" v-if="showSearchOption">
                  ...
                  <form>
                    <div class="input-group mb-4">
                      ...
                      <input
                        ...
                        class="form-control"
                        @input="
                          search(searchByVehicleNumber, 'searchByVehicleNumber')
                        "
                      />
              ...
              <!-- {{-- end search by Vehicle Number --}} -->
              <!--Clear button-->
              <v-btn block color="info" @click="clearSearchFields" class="my-4">
                <v-icon dark left>restore</v-icon>
                Clear All
              </v-btn>
            </div>
          ...
          <!-- search end -->
          <!--SELECT SEARCH-->
          <div class="sentence text-center mb-6">Pick a category !</div>
          <v-select-search
            @input="
              search(
                currentRotationCategory ? currentRotationCategory.id : null,
          ...
          <table class="table table-hover">
            ...
            <tbody>
              <tr v-for="(rotation, i) in sortedRows" :key="i">
                ...
                <td
                  class="text-uppercase align-middle fitCell"
                  style="color: #01a3a4"
                >
                  {{ rotation.vehicle }}
                </td>
                <td class="align-middle fitCell" style="color: #3c6382">
                  {{ rotation.job_id }}
                </td>
                <td class="align-middle fitCell" style="color: #3c6382">
                  {{ rotation.rotationsCategory }}
                ...
                <td
                  colspan="2"
                  class="font-italic align-middle fitCell"
                  style="color: grey"
                >
                  {{ rotation.note }}
                </td>
...
export default {
  ...
  computed: {
    sortedRows: function () {
      return this.rotations.sort((a, b) => {
        let modifier = 1;
    ...
    search(searchValue, type) {
      if (searchValue == null) {
        ...
        for (let [key, value] of this.searchQueryArray) {
          this.searchQuery =
            (this.searchQuery != null ? this.searchQuery : "") +
            "&" +
            key +
            "=" +
            value;
