        ...
        <div class="pa-0 ma-0 " v-if="$mq=='desktop'">
            ...
            <div>
                ...
                <div class="row col-12">
                    <v-btn color="grey" text tile class="float-left" :to="mySpecialShiftsRoute">
                        ...
                        <v-col cols="6" class="pl-0 float-left">
                            ...
                            >
                                ...
                                <v-date-picker v-model="specialShift.SingInDate" scrollable>
                                    ...
                                    <v-btn text color="primary" @click="$refs.dateDate.save(specialShift.SingInDate)">
                                        OK
                                    </v-btn>
                                </v-date-picker>
                            </v-dialog>
                        ...
                        <v-col cols="6" class="pr-0 mr-0 float-right">
                            ...
                            >
                                ...
                                <v-time-picker v-if="modal_dateTime" v-model="specialShift.SingInTime" format="24hr">
                                    ...
                                    <v-btn text color="primary" @click="$refs.dateTime.save(specialShift.SingInTime)">
                                        OK
                                    </v-btn>
                                </v-time-picker>
                            </v-dialog>
                ...
                <div v-if="coveringShift_show">
                    ...
                    <div class="form-group row col-12 px-0 mx-0">
                        <v-col cols="6" class="pl-0 float-left">
                            <!-- car   -->
                            <div class="form-group">
                                <v-text-field label="Car" v-model="specialShift.Car" type="text"
            ...
            <div class="container px-4">
                ...
                <div>
                    ...
                    <div v-if="openShift_show">
                        <!-- badge id  -->
                        <div class="form-group">
                            <v-text-field label="Driver ID" v-model="specialShift.PermitNumber"
                        ...
                        <div class="form-group row col-12 px-0 mx-0">
                                ...
                                >
                                    ...
                                    <v-date-picker v-model="specialShift.SingInDate" scrollable>
                                        ...
                                        <v-btn text color="primary"
                                               @click="$refs.dateDate.save(specialShift.SingInDate)">OK
                                        </v-btn>
                                    </v-date-picker>
                                </v-dialog>
                            </v-col>
                            ...
                            <v-col cols="6" class="pr-0 mr-0 float-right">
                                ...
                                >
                                    ...
                                    <v-time-picker v-if="modal_dateTime" v-model="specialShift.SingInTime"
                                                   format="24hr">
                                        <div class="flex-grow-1"></div>
                                        <v-btn text color="primary" @click="modal_dateTime = false">Cancel</v-btn>
                                        <v-btn text color="primary"
                                               @click="$refs.dateTime.save(specialShift.SingInTime)">OK
                                        </v-btn>
                                    </v-time-picker>
                                </v-dialog>
                            </v-col>
...
<script>
    ...
    export default {
        ...
        data() {
            return {
                inputErrors: [],
                mySpecialShiftsRoute: {name: "DispatcherDashboard_specialShifts"},
                specialShift: {
                    PermitNumber: "",
                    SingInDate: "",
                    SingInTime: "",
        ...
        methods: {
            ...
            AddOpenShift() {
                ...
                axios
                    .put(
                        this.BASE_URL() + "/api/dispatcher/specialShift/" + this.id,
                        this.specialShift
                    )
                    .then(response => {
                        this.$router.push({
