            ...
            <div>
                ...
                <div v-if="openShift_show">
                        ...
                        <v-col cols="6" class="pl-0 float-left">
                            ...
                            >
                                ...
                                <v-date-picker v-model="openShift.SingInDate" scrollable>
                                    ...
                                    <v-btn text color="primary" @click="$refs.dateDate.save(openShift.SingInDate)">OK
                                    </v-btn>
                                </v-date-picker>
                            </v-dialog>
                        </v-col>
                        ...
                        <v-col cols="6" class="pr-0 mr-0 float-right">
                            ...
                            >
                                ...
                                <v-time-picker v-if="modal_dateTime" v-model="openShift.SingInTime" format="24hr">
                                    ...
                                    <v-btn text color="primary" @click="$refs.dateTime.save(openShift.SingInTime)">OK
                                    </v-btn>
                                </v-time-picker>
                            </v-dialog>
                        </v-col>
                    ...
                    <div class="row col-12 mt-4">
                        <v-btn color="primary" tile class="float-left" type="submit" @click.prevent="AddOpenShift()">
                            submit
                        </v-btn>
                        <v-btn
                ...
                <div v-if="coveringShift_show">
                        ...
                        <v-col cols="6" class="pl-0 float-left">
                            ...
                            >
                                ...
                                <v-date-picker v-model="coveringShift.SingInDate" scrollable>
                                    <div class="flex-grow-1"></div>
                                    <v-btn text color="primary" @click="modal_dateDate = false">Cancel</v-btn>
                                    <v-btn text color="primary" @click="$refs.dateDate.save(coveringShift.SingInDate)">
                                        OK
                                    </v-btn>
                                </v-date-picker>
                            </v-dialog>
                        ...
                        <v-col cols="6" class="pr-0 mr-0 float-right">
                            ...
                            >
                                ...
                                <v-time-picker v-if="modal_dateTime" v-model="coveringShift.SingInTime" format="24hr">
                                    <div class="flex-grow-1"></div>
                                    <v-btn text color="primary" @click="modal_dateTime = false">Cancel</v-btn>
                                    <v-btn text color="primary" @click="$refs.dateTime.save(coveringShift.SingInTime)">
                                        OK
                                    </v-btn>
                                </v-time-picker>
                            </v-dialog>
                    ...
                    <div class="form-group row col-12 px-0 mx-0">
                        <v-col cols="6" class="pl-0 float-left">
                            <!-- car   -->
                            <div class="form-group">
                                <v-text-field label="Car" v-model="coveringShift.Car" type="text"
                                              name="job_id"></v-text-field>
                            </div>
                        </v-col>
                        ...
                        <v-col cols="6" class="pr-0 mr-0 float-right">
                            <!-- car covered by  -->
                            <div class="form-group">
                                <v-text-field label="Car Covered by" v-model="coveringShift.CarCoveredBy" type="text"
                                              name="job_id"></v-text-field>
                            </div>
                        </v-col>
                    ...
                    <!-- submit btn -->
                    <div class="row col-12 mt-4">
                        <v-btn color="primary" tile class="float-left" type="submit"
                               @click.prevent="AddCoveringShift()">submit
                        </v-btn>
                        <v-btn
                            color="grey lighten-1"
                            dark
        ...
        <div class="pa-0 ma-0 " v-if="$mq=='mobile'">
            ...
            <div class="container px-4">
                <div>
                    ...
                    <!-- back button -->
                    <div class="">
                        <v-btn color="grey" text tile class="" block :to="directorsRoute">
                            <v-icon class="mr-2">keyboard_return</v-icon>
                            special shifts
                        </v-btn>
                    </div>
                    ...
                    <div v-if="openShift_show">
                            ...
                            <v-col cols="6" class="pl-0 float-left">
                                ...
                                >
                                    ...
                                    <v-date-picker v-model="openShift.SingInDate" scrollable>
                                        <div class="flex-grow-1"></div>
                                        <v-btn text color="primary" @click="modal_dateDate = false">Cancel</v-btn>
                                        <v-btn text color="primary" @click="$refs.dateDate.save(openShift.SingInDate)">
                                            OK
                                        </v-btn>
                                    </v-date-picker>
                                </v-dialog>
                            ...
                            <v-col cols="6" class="pr-0 mr-0 float-right">
                                ...
                                >
                                    ...
                                    <v-time-picker v-if="modal_dateTime" v-model="openShift.SingInTime" format="24hr">
                                        <div class="flex-grow-1"></div>
                                        <v-btn text color="primary" @click="modal_dateTime = false">Cancel</v-btn>
                                        <v-btn text color="primary" @click="$refs.dateTime.save(openShift.SingInTime)">
                                            OK
                                        </v-btn>
                                    </v-time-picker>
                                </v-dialog>
                        ...
                        <!-- submit btn -->
                            <v-btn color="primary" block tile class="" type="submit"
                                   @click.prevent="AddOpenShift()">submit
                            </v-btn>
                            <v-btn
                                color="grey lighten-1"
                                dark
                    ...
                    <div v-if="coveringShift_show">
                        <!-- badge id  -->
                        <div class="form-group">
                            <v-text-field label="Driver ID" v-model="coveringShift.PermitNumber"
                        ...
                        <div class="form-group row col-12 px-0 mx-0">
                                ...
                                >
                                    ...
                                    <v-date-picker v-model="coveringShift.SingInDate" scrollable>
                                        ...
                                        <v-btn text color="primary"
                                               @click="$refs.dateDate.save(coveringShift.SingInDate)">OK
                                        </v-btn>
                                    </v-date-picker>
                                </v-dialog>
                            </v-col>
                            ...
                            <v-col cols="6" class="pr-0 mr-0 float-right">
                                ...
                                >
                                    ...
                                    <v-time-picker v-if="modal_dateTime" v-model="coveringShift.SingInTime"
                                                   format="24hr">
                                        <div class="flex-grow-1"></div>
                                        <v-btn text color="primary" @click="modal_dateTime = false">Cancel</v-btn>
                                        <v-btn text color="primary"
                                               @click="$refs.dateTime.save(coveringShift.SingInTime)">OK
                                        </v-btn>
                                    </v-time-picker>
                                </v-dialog>
                            </v-col>
                        ...
                        <div class="form-group row col-12 px-0 mx-0">
                            ...
                            <v-col cols="6" class="pr-0 mr-0 float-right">
                                <!-- car covered by  -->
                                <div class="form-group">
                                    <v-text-field label="Car Covered by" v-model="coveringShift.CarCoveredBy"
                                                  type="text" name="job_id"></v-text-field>
                                </div>
                            </v-col>
                        ...
                        <!-- submit btn -->
                        <div class="row col-12 mt-4">
                            <v-btn color="primary" tile class="" block type="submit"
                                   @click.prevent="AddCoveringShift()">submit
                            </v-btn>
                            <v-btn
                                color="grey lighten-1"
...
<script>
    ...
    export default {
        ...
        data() {
            return {
                inputErrors: [],
                directorsRoute: {name: "DispatcherDashboard_specialShifts"},
                openShift: {
                    PermitNumber: "",
                    SingInDate: "",
                    SingInTime: "",
        ...
        methods: {
            ...
            AddOpenShift() {
                ...
                axios
                    .post(this.BASE_URL() + "/api/dispatcher/specialShift", this.openShift)
                    .then(response => {
            ...
            AddCoveringShift() {
                ...
                axios
                    .post(
                        this.BASE_URL() + "/api/dispatcher/specialShift",
                        this.coveringShift
                    )
                    .then(response => {
