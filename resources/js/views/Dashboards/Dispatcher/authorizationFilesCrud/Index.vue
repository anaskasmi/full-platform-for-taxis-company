        ...
        <div class="pa-0 ma-0 " v-if="$mq=='mobile'">
            ...
            <div class="container px-4">
                <div >
                    ...
                    <!-- {{-- collapse button --}} -->
                    <v-btn block outlined tile class="my-4" color="info" @click="showSearchOption = !showSearchOption">
                        <v-icon color="info darken-1" class="mx-3">arrow_drop_down</v-icon>
                        Search options
                    </v-btn>
                    <!-- {{-- end collapse button --}} -->
                    ...
                    <div class="table-responsive" v-if="!isLoading">
                        <table class="table table-striped table-hover">
                            ...
                            <tr>
                                <th scope="col">File</th>
                                <th @click="sort('first_name')" class="fitCell align-middle" scope="col">Name</th>
                                <th @click="sort('account_type')" class="fitCell align-middle" scope="col">Account Type</th>
                                <th @click="sort('account_number')" class="fitCell align-middle" scope="col">Account Number</th>
                                <th @click="sort('po_number')" class="fitCell align-middle" scope="col">PO</th>
                                <th @click="sort('status')" class="fitCell align-middle" scope="col">Status</th>
                                <th @click="sort('expiry_date')" class="fitCell align-middle" scope="col">Expiry date</th>
                                <th scope="col"></th>
                            </tr>
                            </thead>
                            <tbody>
                            <tr v-for="(authorizationFile,i) in sortedRows" :key="i" >
                                <td @click="viewDocument(authorizationFile.file_path)" class="fitCell align-middle">
                                    <v-icon style="cursor:pointer">visibility</v-icon>
                                </td>
                                ...
                                <td v-if="expired(authorizationFile)" class="table-danger fitCell align-middle">
                                    {{authorizationFile.expiry_date}}
                                    <span class="font-weight-bold mx-4">--EXPIRED !</span>
                                </td>
                                <td class="fitCell align-middle" v-if="!expired(authorizationFile)">{{authorizationFile.expiry_date}}</td>
                                <td class="text-right">
                                    <v-icon
                                        color="red"
                                        class="ma-4"
