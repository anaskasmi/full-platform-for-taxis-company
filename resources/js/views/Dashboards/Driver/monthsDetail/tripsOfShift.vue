<template>
  <div>
    ...
    <v-btn color="grey" text tile class="float-left" @click="$router.go(-1)">
      <v-icon class="mr-2">keyboard_return</v-icon>back to shifts
    </v-btn>
    <br>
    <br>
    <hr>
      ...
      <v-alert
        ...
        align="center"
      >
        <v-icon class="mb-1" color="primary">description</v-icon>Trips of the selected shift
      </v-alert>
    </div>
    ...
    <v-alert
      ...
      class="mb-12"
      align="center"
    >Sorry, No trips Found For this Month!</v-alert>
  </div>
</template>
<script>
