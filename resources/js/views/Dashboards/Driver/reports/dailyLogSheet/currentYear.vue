                ...
                <div class="row col-12">
                    <v-tooltip top>
                        <template v-slot:activator="{ on }">
                            <a
                                :href="BASE_URL() +
          '/api/driver/reports/currentYear/' +
          idEncrypted +
          '/printPDF/'"
                                target="_blank"
                            >
                ...
                <div class="table-responsive">
                    ...
                    <table class="table table-bordered table-hover table-striped">
                        ...
                        <tr v-for="(month, index) in months" :key="index">
                            ...
                            <td class="fitCell">${{getMonthTotal(index)}}
                            </td>
                            <td @click="showMonthShifts(index)">
                                <v-icon class="pa-0 ma-0" style="cursor: pointer;" color="primary">description</v-icon>
                            </td>
    ...
    export default {
        ...
        methods: {
            ...
            getReport() {
                ...
                axios
                    .get(this.BASE_URL() + "/api/driver/reports/DailyLogSheet/currentYear/")
                    .then(res => {
