        ...
        <div v-if="$mq=='desktop'">
            ...
            <div>
                ...
                <v-btn color="success" outlined class="float-right mx-4"
                       :to="{name : 'DriverDashboard_trips_edit',params:{id:id}}">
                    <v-icon class="mr-2">edit</v-icon>
                    edit
                </v-btn>
                <v-btn color="red " outlined class="float-right" @click="deleteTrip(trip.trip_id,trip.name)">
        ...
        <div v-if="$mq=='mobile'">
            ...
            <div>
                ...
                <div class="container px-4">
                    ...
                    <hr/>
                    <v-btn color="success" outlined class="my-2"
                           block
                           :to="{name : 'DriverDashboard_trips_edit',params:{id:id}}">
                        <v-icon class="mr-2">edit</v-icon>
                        edit
                    </v-btn>
                    <v-btn color="red " outlined block class="my-2" @click="deleteTrip(trip.trip_id,trip.name)">
                        <v-icon class="mr-2">delete</v-icon>
                        delete
                    </v-btn>
...
<script>
    ...
    export default {
        ...
        created() {
            ...
            axios.get(this.BASE_URL() + '/api/driver/trip/' + this.id)
                .then(res => {
