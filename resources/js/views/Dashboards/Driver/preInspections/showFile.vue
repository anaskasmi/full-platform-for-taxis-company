                ...
                <div class="table-responsive" v-if="!isLoading">
                    <table class="table table-hover" style="table-layout:fixed">
                        ...
                        <tr>
                            ...
                            <td v-if="slip.glassAndMirrors=='true'" class="text-uppercase font-weight-bold table-success">{{slip.glassAndMirrors}}</td>
                            <td v-else class="text-uppercase font-weight-bold table-warning">{{slip.glassAndMirrors}}</td>
                        </tr>

                        <tr>
                            <td class="text-uppercase font-weight-bold">heater Defroster</td>
                            <td v-if="slip.heaterDefroster=='true'" class="text-uppercase font-weight-bold table-success">{{slip.heaterDefroster}}</td>
                            <td v-else class="text-uppercase font-weight-bold table-warning">{{slip.heaterDefroster}}</td>
                        </tr>

                        <tr>
                            <td class="text-uppercase font-weight-bold">horn</td>
                            <td v-if="slip.horn=='true'" class="text-uppercase font-weight-bold table-success">{{slip.horn}}</td>
                        ...
                        <tr>
                            ...
                            <td v-if="slip.hydraulicBrakeSystem=='true'" class="text-uppercase font-weight-bold table-success">{{slip.hydraulicBrakeSystem}}</td>
                            <td v-else class="text-uppercase font-weight-bold table-warning">{{slip.hydraulicBrakeSystem}}</td>
                        </tr>

                        <tr>
                            <td class="text-uppercase font-weight-bold">interior Exterior</td>
                            <td v-if="slip.interiorExterior=='true'" class="text-uppercase font-weight-bold table-success">{{slip.interiorExterior}}</td>
                            <td v-else class="text-uppercase font-weight-bold table-warning">{{slip.interiorExterior}}</td>
                        </tr>

                        <tr>
                            <td class="text-uppercase font-weight-bold">lampsAndIndicators</td>
                            <td v-if="slip.lampsAndIndicators=='true'" class="text-uppercase font-weight-bold table-success">{{slip.lampsAndIndicators}}</td>
                            <td v-else class="text-uppercase font-weight-bold table-warning">{{slip.lampsAndIndicators}}</td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td v-if="slip.steeringTires=='true'" class="text-uppercase font-weight-bold table-success">{{slip.steeringTires}}</td>
                        ...
                        <tr>
                            ...
                            <td v-if="slip.turnJake=='true'"class="text-uppercase font-weight-bold table-success">{{slip.turnJake}}</td>
                        ...
                        <tr>
                            ...
                            <td v-if="slip.wheelChairLiftAndEmergencyEquipment=='true'" class="text-uppercase font-weight-bold table-success">{{slip.wheelChairLiftAndEmergencyEquipment}}</td>
                            <td v-else class="text-uppercase font-weight-bold table-warning">{{slip.wheelChairLiftAndEmergencyEquipment}}</td>
                        </tr>
                        <tr>
                            <td class="text-uppercase font-weight-bold">wheels And Hubs And Fastners</td>
                            <td v-if="slip.wheelsAndHubsAndFastners=='true'" class="text-uppercase font-weight-bold table-success">{{slip.wheelsAndHubsAndFastners}}</td>
                            <td v-else class="text-uppercase font-weight-bold table-warning">{{slip.wheelsAndHubsAndFastners}}</td>
                        </tr>
                        <tr>
